...
const Listarticle = () => {
  ...
  const fetcharticles = async () => {
    try {
      const res = await axios.get("https://ecommercebackend-woad.vercel.app/api/article")
  ...
  const handleDelete = async (id) => {
    ...
    {
      try {
        await axios.delete(`https://ecommercebackend-woad.vercel.app/api/article/${id}`)
...

          {
            articles.map((art, index) =>
              <tr>
                ...
                <td><button className='btn btn-arning btn-sm' onClick={() => handleUpdate(art._id)}><i class="fa-sharp fa-solid fa-pen-to-square"></i>Update</button></td>
